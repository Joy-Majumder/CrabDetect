...
model = YOLO("/Users/joy0x1/Downloads/UIU Mariner/WORK/DataSet/CustomModel/best.pt")
# model.predict(source="CamImage/1.png", show=True, save=True,conf=0.8, save_crop=True)
model.predict(source="/Users/joy0x1/Downloads/UIU Mariner/WORK/DataSet/videoSource/1.mp4",show=True, conf=0.6,
    imgsz=640,
    save=True,
    verbose=True)